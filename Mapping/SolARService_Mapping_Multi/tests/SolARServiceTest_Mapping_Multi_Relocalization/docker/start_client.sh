...
cd /SolARServiceMappingMultiRelocalizationClient
...
sed -i -e "s/RELOCALIZATION_SERVICE_URL/$RELOCALIZATION_SERVICE_URL/g" /.xpcf/SolARServiceTest_Mapping_Multi_Relocalization_conf.xml
...
sed -i -e "s/MAPPING_SERVICE_URL/$MAPPING_SERVICE_URL/g" /.xpcf/SolARServiceTest_Mapping_Multi_Relocalization_conf.xml
...
sed -i -e "s/PATH_TO_IMAGE_DATA/$PATH_TO_IMAGE_DATA/g" /.xpcf/SolARServiceTest_Mapping_Multi_Relocalization_conf.xml
...
## Start client
./SolARServiceTest_Mapping_Multi_Relocalization -f /.xpcf/SolARServiceTest_Mapping_Multi_Relocalization_conf.xml
