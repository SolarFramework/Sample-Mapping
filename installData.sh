...
# Download maps
curl https://artifact.b-com.com/solar-generic-local/maps/hololens/bcomLab/mapLabA.zip -L -o mapA.zip
unzip -o mapA.zip -d ./data/map_hololens
rm mapA.zip

curl https://artifact.b-com.com/solar-generic-local/maps/hololens/bcomLab/mapLabB.zip -L -o mapB.zip
