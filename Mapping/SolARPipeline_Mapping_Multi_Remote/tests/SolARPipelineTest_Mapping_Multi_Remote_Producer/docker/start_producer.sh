...
cd /SolARPipelineMappingMultiProducer
...
sed -i -e "s/MAPPING_SERVICE_URL/$MAPPING_SERVICE_URL/g" /.xpcf/SolARPipelineTest_Mapping_Multi_Remote_Producer_conf.xml
...
sed -i -e "s/PATH_TO_IMAGE_DATA/$PATH_TO_IMAGE_DATA/g" /.xpcf/SolARPipelineTest_Mapping_Multi_Remote_Producer_conf.xml
...
## Start client
./SolARPipelineTest_Mapping_Multi_Remote_Producer -f /.xpcf/SolARPipelineTest_Mapping_Multi_Remote_Producer_conf.xml
